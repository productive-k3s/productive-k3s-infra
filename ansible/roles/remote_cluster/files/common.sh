...
: "${PRODUCTIVE_K3S_STACK_DOWNLOAD_MAX_RETRIES_DEFAULT:=4}"
: "${PRODUCTIVE_K3S_STACK_DOWNLOAD_CONNECT_TIMEOUT_SECONDS_DEFAULT:=10}"
: "${PRODUCTIVE_K3S_STACK_DOWNLOAD_REQUEST_TIMEOUT_SECONDS_DEFAULT:=180}"
...
PRODUCTIVE_K3S_STACK_DOWNLOAD_MAX_RETRIES="${PRODUCTIVE_K3S_STACK_DOWNLOAD_MAX_RETRIES:-${PRODUCTIVE_K3S_STACK_DOWNLOAD_MAX_RETRIES_DEFAULT}}"
PRODUCTIVE_K3S_STACK_DOWNLOAD_CONNECT_TIMEOUT_SECONDS="${PRODUCTIVE_K3S_STACK_DOWNLOAD_CONNECT_TIMEOUT_SECONDS:-${PRODUCTIVE_K3S_STACK_DOWNLOAD_CONNECT_TIMEOUT_SECONDS_DEFAULT}}"
PRODUCTIVE_K3S_STACK_DOWNLOAD_REQUEST_TIMEOUT_SECONDS="${PRODUCTIVE_K3S_STACK_DOWNLOAD_REQUEST_TIMEOUT_SECONDS:-${PRODUCTIVE_K3S_STACK_DOWNLOAD_REQUEST_TIMEOUT_SECONDS_DEFAULT}}"
