...
assert_contains_file "${WORKTREE}/scenarios/multipass/scripts/common.sh" "PRODUCTIVE_K3S_CORE_VERSION_DEFAULT:=${TARGET_VERSION}"
assert_contains_file "${WORKTREE}/scenarios/onprem-basic/scripts/common.sh" "PRODUCTIVE_K3S_CORE_VERSION_DEFAULT:=${TARGET_VERSION}"
assert_contains_file "${WORKTREE}/scenarios/onprem-basic-arm/scripts/common.sh" "PRODUCTIVE_K3S_CORE_VERSION_DEFAULT:=${TARGET_VERSION}"
...
assert_contains_file "${WORKTREE}/profiles/multipass/1-server-2-agents.env" "# PRODUCTIVE_K3S_VERSION=${TARGET_VERSION}"
assert_contains_file "${WORKTREE}/profiles/aws-single-node/basic.env" "PRODUCTIVE_K3S_VERSION=${TARGET_VERSION}"
assert_contains_file "${WORKTREE}/profiles/on-prem/basic.env" "# PRODUCTIVE_K3S_VERSION=${TARGET_VERSION}"
assert_contains_file "${WORKTREE}/profiles/on-prem/arm.env" "# PRODUCTIVE_K3S_VERSION=${TARGET_VERSION}"
assert_contains_file "${WORKTREE}/scenarios/aws-single-node/aws.env.example" "PRODUCTIVE_K3S_VERSION=${TARGET_VERSION}"
assert_contains_file "${WORKTREE}/scenarios/onprem-basic/onprem.env.example" "# PRODUCTIVE_K3S_VERSION=${TARGET_VERSION}"
assert_contains_file "${WORKTREE}/scenarios/onprem-basic-arm/onprem.env.example" "# PRODUCTIVE_K3S_VERSION=${TARGET_VERSION}"
assert_contains_file "${WORKTREE}/scenarios/multipass/README.md" "PRODUCTIVE_K3S_VERSION=${TARGET_VERSION}"
assert_contains_file "${WORKTREE}/scenarios/onprem-basic/README.md" "PRODUCTIVE_K3S_VERSION=${TARGET_VERSION}"
assert_contains_file "${WORKTREE}/scenarios/onprem-basic-arm/README.md" "PRODUCTIVE_K3S_VERSION=${TARGET_VERSION}"
assert_contains_file "${WORKTREE}/scenarios/aws-single-node/README.md" "PRODUCTIVE_K3S_VERSION=${TARGET_VERSION}"
